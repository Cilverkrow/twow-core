...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_PERFLOG_TICK_STATS_INTERVAL,
    ...
    CONFIG_UINT32_FUNSERVER_LOOT_BONUS_SELECTION_MULTIPLIER,
    CONFIG_UINT32_FUNSERVER_RARE_RESPAWN_DIVISOR,
    CONFIG_UINT32_FUNSERVER_RARE_RESPAWN_MIN_SECONDS,
    CONFIG_UINT32_FUNSERVER_RARE_RESPAWN_MAX_SECONDS,
    CONFIG_UINT32_FUNSERVER_LOOT_UNITS_RARE,
    CONFIG_UINT32_FUNSERVER_LOOT_UNITS_DUNGEON,
    CONFIG_UINT32_FUNSERVER_LOOT_UNITS_RAID,
    CONFIG_UINT32_FUNSERVER_LOOT_FLOOR_RARE,
    CONFIG_UINT32_FUNSERVER_LOOT_FLOOR_DUNGEON,
    CONFIG_UINT32_FUNSERVER_LOOT_FLOOR_RAID,
    CONFIG_UINT32_FUNSERVER_LOOT_BOE_LEVEL_WINDOW,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_FUNSERVER_LOOT_BONUS_DUPLICATE_DECAY,
    CONFIG_FLOAT_FUNSERVER_LOOT_UNITS_DECAY,
    CONFIG_FLOAT_FUNSERVER_LOOT_BOE_EPIC_SHARE,
    // twow-repo#323: 3 content types x 6 qualities, contiguous (poor..legendary).
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RARE_POOR,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RARE_COMMON,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RARE_UNCOMMON,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RARE_RARE,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RARE_EPIC,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RARE_LEGENDARY,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_DUNGEON_POOR,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_DUNGEON_COMMON,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_DUNGEON_UNCOMMON,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_DUNGEON_RARE,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_DUNGEON_EPIC,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_DUNGEON_LEGENDARY,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RAID_POOR,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RAID_COMMON,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RAID_UNCOMMON,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RAID_RARE,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RAID_EPIC,
    CONFIG_FLOAT_FUNSERVER_LOOT_WEIGHT_RAID_LEGENDARY,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_FUNSERVER_LOOT_BONUS_WORLD_BOSS,
    CONFIG_BOOL_FUNSERVER_LOOT_BONUS_DUNGEON_BOSS,
    CONFIG_BOOL_FUNSERVER_LOOT_BONUS_RAID_BOSS,
    CONFIG_BOOL_FUNSERVER_LOOT_BONUS_BOSS_CHEST,
    CONFIG_BOOL_FUNSERVER_LOOT_UNITS_ENABLED,
    CONFIG_BOOL_FUNSERVER_RARE_RESPAWN_ENABLED,
