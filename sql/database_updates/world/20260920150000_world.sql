...
-- trigger volumes. Keep the teleport records idempotent and scoped to them.
INSERT INTO `areatrigger_teleport` (
    ...
    (5340, 'Tower of Karazhan - Entrance', 'You must be level 60 and possess the Upper Karazhan Tower Key to enter.', 60, 1678803, 0, 814, -11044.265625, -1991.812134, 98.740768, 2.164079),
    (5341, 'Tower of Karazhan - Exit', '', 0, 0, 0, 0, -10847.659180, -1866.291504, 117.173531, 1.722723)
