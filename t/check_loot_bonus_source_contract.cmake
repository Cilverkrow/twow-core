...
if (NOT scan330_count EQUAL 118 OR NOT scan330_csv_rows EQUAL 118)
  message(FATAL_ERROR "#330 expects 118 rows (111 class A + 7 approved class B) (migration ${scan330_count}, csv ${scan330_csv_rows})")
endif()
